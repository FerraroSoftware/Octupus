          ...
          <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="grid items-center max-w-5xl grid-cols-1 mx-auto gap-y-12 lg:grid-cols-2 gap-x-16 xl:gap-x-24">
              ...
              <div
                ...
                data-aos-duration="1000"
              >
                <h2 className="text-xs font-bold tracking-wide text-indigo-600 uppercase">
                  Original Octupus Collection
                </h2>
                <p className="mt-6 text-4xl font-bold text-white">
                  Octupus - that you'll love
                </p>
                ...
                <div className="mt-10">
                  <a
                    href="#"
                    title=""
                    className="relative inline-flex items-center justify-center py-3 pl-16 pr-8 text-base font-bold text-white transition-all duration-200 bg-transparent border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 hover:bg-gray-900 hover:text-white"
                    role="button"
                  >
